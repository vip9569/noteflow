...
- Integrate with Micrometer + Prometheus for metrics
- Use MDC for structured request logging with correlation IDs
...
services:
  ...
  backend:
    ...
    ports: ["8080:8080"]
    environment:
      SPRING_DATASOURCE_URL: jdbc:mysql://db:3306/taskflow_db
